...
[[论文库/Qwen3-TTS Technical Report/Qwen3-TTS 模型组件架构细节/Qwen2-Audio 多模态音频理解模型详解|Qwen2-Audio 多模态音频理解模型详解]]
...
[[论文库/Qwen3-TTS Technical Report/Qwen3-TTS 模型组件架构细节/DiT（Diffusion Transformer）在语音合成中的应用详解|DiT（Diffusion Transformer）在语音合成中的应用详解]]
...
[[论文库/Qwen3-TTS Technical Report/Qwen3-TTS 模型组件架构细节/BigVGAN 通用神经声码器详解|BigVGAN 通用神经声码器详解]]
...
[[论文库/Qwen3-TTS Technical Report/Qwen3-TTS 模型组件架构细节/Mimi 音频编解码器架构详解|Mimi 音频编解码器架构详解]]
...
[[论文库/Qwen3-TTS Technical Report/Qwen3-TTS 模型组件架构细节/MTP 模块（Multi-Token Prediction）详解|MTP 模块（Multi-Token Prediction）详解]]
