...
🗺️**TTS Benchmark 四维体系**
1. **评测数据集与测试集** — 零样本克隆、多语言、长语音等场景的标准测试集
2. **主观评价方法** — MOS / CMOS / MUSHRA / AB 测试等人工听感评测
3. **客观评价指标** — 语音质量、说话人相似度、内容准确性、韵律多样性等自动化指标
4. **评测框架与工具链** — 端到端的开源评测 Pipeline
...
[2-主观评价方法详解](2-主观评价方法详解.md)

[1-评测数据集与测试集](1-评测数据集与测试集.md)

[4-端到端评测实战流程](4-端到端评测实战流程.md)

[3-评测框架与工具链](3-评测框架与工具链.md)

[5-客观评价指标体系详解](5-客观评价指标体系详解.md)

[7-前沿TTS模型Benchmark横评](7-前沿TTS模型Benchmark横评.md)

[6-语音编解码器与Tokenizer评测](6-语音编解码器与Tokenizer评测.md)

[10-TTS评测前沿趋势与开放挑战](10-TTS评测前沿趋势与开放挑战.md)

[8-多语言与跨语言TTS评测](8-多语言与跨语言TTS评测.md)

[9-可控语音生成与安全评测](9-可控语音生成与安全评测.md)
