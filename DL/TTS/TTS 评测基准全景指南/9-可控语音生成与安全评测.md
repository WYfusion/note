...
🛡️**Audio Deepfake Detection**：随着零样本 TTS 质量飞速提升，合成语音的「真伪鉴别」成为关键安全问题。
...
- [[2-主观评价方法详解]] — MOS/AB 测试等主观评测方法
- [[5-客观评价指标体系详解]] — 客观指标体系全览
- [[7-前沿TTS模型Benchmark横评]] — 各模型可控能力对比
- [[8-多语言与跨语言TTS评测]] — 多语言评测维度
