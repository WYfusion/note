> 📎 **前置**：Gradio；[[私人与共享/GPT-SoVITS 系列全栈总纲/8. 推理流程（Inference Pipeline）|8. 推理流程（Inference Pipeline）]]；采样参数语义；[[5.3 推理采样策略|5.3 推理采样策略]]。
...
> 🤔 **多参考音频的未来**：FACodec 路线（NaturalSpeech 3）能显式分离音色 / 韵律 / 情感，比 GPT-SoVITS 的加权融合更精确。见 [[13.5 与端到端 Flow - Diffusion TTS 的未来融合|13.5 与端到端 Flow - Diffusion TTS 的未来融合]]。

## 8. 子页面

[[9.2.1 参数面板（top_k - top_p - temperature - speed）|9.2.1 参数面板（top_k - top_p - temperature - speed）]]

[[9.2.2 多参考音频与情感槽位|9.2.2 多参考音频与情感槽位]]
