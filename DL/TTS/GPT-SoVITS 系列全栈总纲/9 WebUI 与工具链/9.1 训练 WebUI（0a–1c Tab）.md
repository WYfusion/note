> 📎 **前置**：Gradio；[[私人与共享/GPT-SoVITS 系列全栈总纲/7. 训练管线（端到端工作流）|7. 训练管线（端到端工作流）]]；UVR5（Ultimate Vocal Remover）；Slicer；FunASR / Faster-Whisper；cnhubert。
...
[[9.1.1 0a UVR5（人声分离）|9.1.1 0a UVR5（人声分离）]]

[[9.1.2 0b 语音切分（slicer）|9.1.2 0b 语音切分（slicer）]]

[[9.1.3 0c ASR（FunASR - Faster-Whisper 转写）|9.1.3 0c ASR（FunASR - Faster-Whisper 转写）]]

[[9.1.4 1a 文本特征提取|9.1.4 1a 文本特征提取]]

[[9.1.5 1b HuBERT 特征提取|9.1.5 1b HuBERT 特征提取]]
...
[[9.1.6 1c 语义 token 计算|9.1.6 1c 语义 token 计算]]

1. FunASR: [https://github.com/modelscope/FunASR](https://github.com/modelscope/FunASR)

[[9.1.7 1ba - 1bb s2 与 s1 训练入口|9.1.7 1ba - 1bb s2 与 s1 训练入口]]
