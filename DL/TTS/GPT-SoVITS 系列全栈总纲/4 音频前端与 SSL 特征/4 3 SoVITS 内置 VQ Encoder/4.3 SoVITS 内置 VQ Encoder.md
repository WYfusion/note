> 📎 **前置**：[[1.4 向量量化（VQ）与离散语义 Token|1.4 向量量化（VQ）与离散语义 Token]]；codebook lookup；EMA 更新；Straight-Through Estimator；FSQ。
...
[[4.3.1 Pre-VQ Conv Stack|4.3.1 Pre-VQ Conv Stack]]

[[4.3.2 VQ Layer 实现细节|4.3.2 VQ Layer 实现细节]]
