> 📎 **前置**：[[1.3 自监督语音表征（SSL Features）|1.3 自监督语音表征（SSL Features）]]；HuBERT 论文与 mask 预测训练；隐层探针；ContentVec。
...
[[4.2.1 16kHz 强制重采样的来源|4.2.1 16kHz 强制重采样的来源]]

[[4.2.2 帧率对齐（50Hz SSL ↔ 25Hz semantic）|4.2.2 帧率对齐（50Hz SSL ↔ 25Hz semantic）]]
