...
> [!important]
> 
> 先读 [[2.2 四大核心组件职责|2.2 四大核心组件职责]]。本页是 AR 架构总览、详细实现遵 L2-5。
...
1. [[私人与共享/GPT-SoVITS 系列全栈总纲/5. AR - T2S 模型（GPT 语义建模阶段）|5. AR - T2S 模型（GPT 语义建模阶段）]]中详细推导。