> 📎 **前置知识**：建议先通读 [[私人与共享/GPT-SoVITS 系列全栈总纲/1. 前置基础与理论根基|1. 前置基础与理论根基]]（VITS / VALL-E / SSL / VQ / CFM 五条主线）；熟悉 PyTorch Lightning 训练范式；理解「自回归 token 生成 + 非自回归声码解码」两段式思想。
...
[[2.1 高层架构图与数据流|2.1 高层架构图与数据流]]

[[2.2 四大核心组件职责|2.2 四大核心组件职责]]
