...
[[5.4.1 学习率 Warmup + Cosine Decay|5.4.1 学习率 Warmup + Cosine Decay]]
...
[[5.4.2 Gradient Clipping|5.4.2 Gradient Clipping]]

1. GPT-SoVITS: `s1_train.py`, `GPT_SoVITS/AR/models/t2s_lightning_module.py`.

[[5.4.3 Checkpoint 命名与版本检测|5.4.3 Checkpoint 命名与版本检测]]