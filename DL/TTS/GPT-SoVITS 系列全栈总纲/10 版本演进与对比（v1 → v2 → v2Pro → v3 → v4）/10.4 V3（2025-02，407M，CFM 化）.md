> 📎 **前置**：[[1.5 Flow Matching - CFM（v3-v4 的核心范式）|1.5 Flow Matching - CFM（v3-v4 的核心范式）]]；BigVGAN-v2；Classifier-Free Guidance (CFG)；ODE 求解器；[[私人与共享/GPT-SoVITS 系列全栈总纲/5. AR - T2S 模型（GPT 语义建模阶段）|5. AR - T2S 模型（GPT 语义建模阶段）]]。
...
> [⚠️] **两个原因叠加**：① BigVGAN-24k 上采样镜像未压住；② CFM 8 步 Euler 误差在 sample edge 放大。V4 同时推 48k + ODE 10 步修复。详见 [[13.2 v3 - v4 人工感 - 金属音|13.2 v3 - v4 人工感 - 金属音]]。
...
[[10.4.1 V3 训练数据规模（~7000h）|10.4.1 V3 训练数据规模（~7000h）]]

[[10.4.2 V3 金属噪声问题溯源|10.4.2 V3 金属噪声问题溯源]]
