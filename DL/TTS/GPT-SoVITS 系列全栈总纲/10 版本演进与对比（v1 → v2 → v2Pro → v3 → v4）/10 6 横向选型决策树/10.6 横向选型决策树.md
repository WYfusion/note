> 📎 **前置**：[[私人与共享/GPT-SoVITS 系列全栈总纲/10. 版本演进与对比（v1 → v2 → v2Pro → v3 → v4）|10. 版本演进与对比（v1 → v2 → v2Pro → v3 → v4）]]；部署资源环境；SECS / MOS / RTF 指标。
...
[[10.6.1 训练集音质好坏 → 选 V3 还是 V2Pro|10.6.1 训练集音质好坏 → 选 V3 还是 V2Pro]]

[[10.6.2 实时性 - 低延迟 → 选 V2 中型|10.6.2 实时性 - 低延迟 → 选 V2 中型]]

[[10.6.3 音色相似度优先 → V2Pro - ProPlus|10.6.3 音色相似度优先 → V2Pro - ProPlus]]
