> [📎] 前置知识：[[1.1 VITS 原理（SoVITS 的“S”血统）]]、[[1.4 向量量化（VQ）与离散语义 Token]]、[[1.5 Flow Matching - CFM（v3-v4 的核心范式）]]、[[1.6 BigVGAN]]、Mel-spectrogram、Speaker Verification embedding。
