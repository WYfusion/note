> 📎 **前置**：Muyan-TTS (Llama-3.2-3B + SoVITS Decoder)；CosyVoice 2 (Llama-style LLM)；FireRedTTS；Spark-TTS (Qwen-7B)；Step-Audio (130B 全双工)；[[11.4 vs Muyan-TTS（Llama-3.2-3B + SoVITS Decoder）]]。
