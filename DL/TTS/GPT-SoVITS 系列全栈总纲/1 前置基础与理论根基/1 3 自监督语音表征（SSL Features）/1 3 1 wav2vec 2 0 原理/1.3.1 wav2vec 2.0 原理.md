...
> [!important]
> 
> 建议先读 [[1.3 自监督语音表征（SSL Features）]]。本页是 SSL 路线的「对比学习”代表，与下一页 HuBERT（「屏蔽预测」）是两条并行路。
...
Gumbel-Softmax：可微采样，训练时由软最大达代表示 $argmax$，推理时拿 $argmax$。
...
[[1.3.1.1 对比学习与 Quantizer（wav2vec 2.0）]]
