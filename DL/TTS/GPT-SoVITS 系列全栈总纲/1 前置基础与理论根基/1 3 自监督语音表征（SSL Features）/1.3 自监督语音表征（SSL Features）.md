...
> [!important]
> 
> 建议先读 [[1.2 VALL-E 类范式（GPT-SoVITS 的“GPT”血统）]] 了解「为什么需要把语音变成类语义的中间表示」。
...
[[1.3.4 ContentVec - 语义-说话人解耦]]

[[1.3.2 HuBERT 训练目标]]

[[1.3.3 cnhubert（Chinese-HuBERT-base）]]
...
> [!important]
> 
> **关键工程点**：cnhubert 输入**必须**重采样到 16kHz（HuBERT 预训练采样率），与训练目标采样率（v1/v2 32k、v3 24k、v4 48k）**完全解耦**。详见 [[4.2.1 16kHz 强制重采样的来源]]。
