[[1.1 VITS 原理（SoVITS 的“S”血统）|1.1 VITS 原理（SoVITS 的“S”血统）]]
...
> 
> 延伸阅读：[[私人与共享/GPT-SoVITS 系列全栈总纲/2. GPT-SoVITS 整体架构|2. GPT-SoVITS 整体架构]]
...
- 下一章入口：[[私人与共享/GPT-SoVITS 系列全栈总纲/2. GPT-SoVITS 整体架构|2. GPT-SoVITS 整体架构]]

- 数据流细节：[[2.1 高层架构图与数据流|2.1 高层架构图与数据流]]

- 解码器深入：[[私人与共享/GPT-SoVITS 系列全栈总纲/6. SoVITS 解码器（声学生成阶段）|6. SoVITS 解码器（声学生成阶段）]]
...
[[1.2 VALL-E 类范式（GPT-SoVITS 的“GPT”血统）|1.2 VALL-E 类范式（GPT-SoVITS 的“GPT”血统）]]

[[1.3 自监督语音表征（SSL Features）|1.3 自监督语音表征（SSL Features）]]

[[1.4 向量量化（VQ）与离散语义 Token|1.4 向量量化（VQ）与离散语义 Token]]

[[1.5 Flow Matching - CFM（v3-v4 的核心范式）|1.5 Flow Matching - CFM（v3-v4 的核心范式）]]
