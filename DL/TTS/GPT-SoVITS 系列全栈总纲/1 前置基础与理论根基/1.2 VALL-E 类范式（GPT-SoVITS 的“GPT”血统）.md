...
> [!important]
> 
> 建议先了解 [[1.3 自监督语音表征（SSL Features）|1.3 自监督语音表征（SSL Features）]] 与 [[1.4 向量量化（VQ）与离散语义 Token|1.4 向量量化（VQ）与离散语义 Token]]，因为 VALL-E 范式的前提是「语音能被 tokenize」。
...
详见 [[5.1 Text2SemanticDecoder 总结构|5.1 Text2SemanticDecoder 总结构]]。
...
详见 [[私人与共享/GPT-SoVITS 系列全栈总纲/11. 与同期主流 TTS 的对比|11. 与同期主流 TTS 的对比]]。
...
[[1.2.1 离散语音 Token 化思想|1.2.1 离散语音 Token 化思想]]

[[1.2.2 Neural Audio Codec 概览|1.2.2 Neural Audio Codec 概览]]

[[1.2.3 AR + NAR 双阶段（VALL-E 原版）|1.2.3 AR + NAR 双阶段（VALL-E 原版）]]

[[1.2.4 In-Context Voice Cloning|1.2.4 In-Context Voice Cloning]]

---

## 1.2.7 延伸阅读

- [[私人与共享/GPT-SoVITS 系列全栈总纲/5. AR - T2S 模型（GPT 语义建模阶段）|5. AR - T2S 模型（GPT 语义建模阶段）]]

- [[11.4 vs Muyan-TTS（Llama-3.2-3B + SoVITS Decoder）|11.4 vs Muyan-TTS（Llama-3.2-3B + SoVITS Decoder）]]
