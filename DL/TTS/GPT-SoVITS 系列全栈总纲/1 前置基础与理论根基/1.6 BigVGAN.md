...
> [!important]
> 
> 建议先了解 [[1.5 Flow Matching - CFM（v3-v4 的核心范式）]]，BigVGAN 是 CFM 输出 mel 之后的最后一步。
...
- **v3 vs v4 的 vocoder 差异**：v3 的 24k → 48k 需要外部上采样导致金属感；v4 改为**原生 48k**，金属音消失。详见 [[10.4.2 V3 金属噪声问题溯源]]。

---

## 1.6.3 延伸阅读

- [[2.4.4 GPT_SoVITS-BigVGAN-]]（代码目录）
