...
[[私人与共享/GPT-SoVITS 系列全栈总纲/1 前置基础与理论根基/1 5 Flow Matching CFM（v3 v4 的核心范式）/1 5 2 Flow Matching 训练目标/1.5.2.1 Conditional FM 目标推导|1.5.2.1 Conditional FM 目标推导]]
...
> [!important]
> 
> 先读 [[私人与共享/GPT-SoVITS 系列全栈总纲/1 前置基础与理论根基/1 5 Flow Matching CFM（v3 v4 的核心范式）/1.5.1 Continuous Normalizing Flow (CNF)|1.5.1 Continuous Normalizing Flow (CNF)]]。本页启序上是 Flow Matching 理论的「主舌看点」。
...
详见 [[1.5.2.1 Conditional FM 目标推导|1.5.2.1 Conditional FM 目标推导]]。
