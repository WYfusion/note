...
> [!important]
> 
> 建议先读 [[私人与共享/GPT-SoVITS 系列全栈总纲/1. 前置基础与理论根基|1. 前置基础与理论根基]] 了解 GPT-SoVITS 五条线的全景。
...
各项含义见 [[6.1.7 损失函数总览（mel - KL - adv - fm）|6.1.7 损失函数总览（mel - KL - adv - fm）]]。
...
[[1.1.1 条件变分自编码器（CVAE）框架|1.1.1 条件变分自编码器（CVAE）框架]]
...
[[1.1.2 Normalizing Flow 与 Affine Coupling Layer|1.1.2 Normalizing Flow 与 Affine Coupling Layer]]

1. Shen, J. et al. (2018). _Tacotron 2_. ICASSP.

[[1.1.3 Monotonic Alignment Search (MAS)|1.1.3 Monotonic Alignment Search (MAS)]]

[[1.1.4 HiFi-GAN 解码器（VITS 原版波形头）|1.1.4 HiFi-GAN 解码器（VITS 原版波形头）]]

[[1.1.5 ELBO 深入：证据下界的思想、逻辑与应用|1.1.5 ELBO 深入：证据下界的思想、逻辑与应用]]