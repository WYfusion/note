...
> [!important]
> 
> 建议先读 [[1.2.1 离散语音 Token 化思想|1.2.1 离散语音 Token 化思想]]。Neural Audio Codec 是该思想的「波形级实现路线」。
...
详见 [[1.2.2.1 RVQ（Residual VQ）原理|1.2.2.1 RVQ（Residual VQ）原理]]。
...
详见 [[1.2.2.2 EnCodec - SoundStream - DAC 简表|1.2.2.2 EnCodec - SoundStream - DAC 简表]]。
...
[[1.2.2.1 RVQ（Residual VQ）原理|1.2.2.1 RVQ（Residual VQ）原理]]

[[1.2.2.2 EnCodec - SoundStream - DAC 简表|1.2.2.2 EnCodec - SoundStream - DAC 简表]]
