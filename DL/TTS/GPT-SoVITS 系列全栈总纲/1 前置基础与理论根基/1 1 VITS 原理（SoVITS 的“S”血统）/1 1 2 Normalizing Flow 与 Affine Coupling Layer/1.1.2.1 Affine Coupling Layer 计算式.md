...
> [!important]
> 
> 本页属于 [[1.1.2 Normalizing Flow 与 Affine Coupling Layer|1.1.2 Normalizing Flow 与 Affine Coupling Layer]]。
...
> [!important]
> 
> **巧点**：$\text{NN}(x_a) = \text{NN}(y_a)$，于是反向不需重跑 NN、仅简单计算。
...
详见 [[1.1.2.2 Jacobian 与可逆性|1.1.2.2 Jacobian 与可逆性]]。
