...
> [!important]
> 
> 本页属于 [[1.1.2 Normalizing Flow 与 Affine Coupling Layer]]。建议先读 [[1.1.2.1 Affine Coupling Layer 计算式]]。
...
$y_b = x_b odot e^s + t implies x_b = (y_b - t) odot e^{-s}$，但 上面需 $e^s ne 0$。由于 $s in mathbb R$，$e^s > 0$，**总是成立**。
