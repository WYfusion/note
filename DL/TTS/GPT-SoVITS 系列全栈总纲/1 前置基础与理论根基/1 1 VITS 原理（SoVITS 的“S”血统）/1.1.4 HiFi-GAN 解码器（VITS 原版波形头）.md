...
> [!important]
> 
> 该 vocoder 是 VITS / GPT-SoVITS v1/v2 的波形生成头；v3/v4 换为 BigVGAN（见 [[1.6 BigVGAN（仅提一嘴）]]）。
...
[[1.1.4.1 MRF（Multi-Receptive Field）块|1.1.4.1 MRF（Multi-Receptive Field）块]]

[[1.1.4.2 MPD - MSD 判别器|1.1.4.2 MPD - MSD 判别器]]
