...
> [!important]
> 
> 建议读过 [[1.1 VITS 原理（SoVITS 的“S”血统）|1.1 VITS 原理（SoVITS 的“S”血统）]]，本页大量与 VITS Flow 对比。
...
详见 [[6.2 V3 - V4 SoVITS（CFM + BigVGAN）|6.2 V3 - V4 SoVITS（CFM + BigVGAN）]]。
...
[[1.5.1 Continuous Normalizing Flow (CNF)|1.5.1 Continuous Normalizing Flow (CNF)]]
...
[[1.5.2 Flow Matching 训练目标|1.5.2 Flow Matching 训练目标]]

1. Du, C. et al. (2024). _CosyVoice_. arXiv:2407.05407.

[[1.5.3 ODE Solver 与 NFE|1.5.3 ODE Solver 与 NFE]]

[[1.5.4 与 Diffusion - Score Matching 的关系|1.5.4 与 Diffusion - Score Matching 的关系]]