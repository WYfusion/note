...
![[1.3 Hybrid 两阶段范式（CosyVoice - Seed-TTS） - Hybrid 范式核心思想.excalidraw|800]]
...
2. **韵律控制**：LM 的序列建模天然适合韵律、停顿等高层特征

3. **音质保证**：FM/Diffusion 在连续空间生成高质量 Mel

4. **灵活扩展**：可独立升级 LM（更大模型）或 FM（更好架构）
