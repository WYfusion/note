...
![[2026-04-18 09.26.13TTS评测范式演化.excalidraw|1200]]
...
![[2026-04-18 09.27.36TTS评测指标组合.excalidraw|1000]]
...
|**评测需求**|**推荐方法**|**详见页面**|
|---|---|---|
|快速原型验证|WER + UTMOS（自动化）|[[3-客观评价指标体系]]|
|论文发表|WER + SIM + UTMOS + MOS|[[DL/TTS/Qwen3-TTS Technical Report/TTS 评测基准全景指南/2-主观评价方法详解]] + [[5]]|
|产品上线|AB Test + 安全评测|[[DL/TTS/Qwen3-TTS Technical Report/TTS 评测基准全景指南/9-可控语音生成与安全评测]]|
|多语言场景|分语言 WER + X-SIM + LID|[[DL/TTS/Qwen3-TTS Technical Report/TTS 评测基准全景指南/8-多语言与跨语言TTS评测]]|
|Codec 开发|PESQ + ViSQOL + FAD|[[DL/TTS/Qwen3-TTS Technical Report/TTS 评测基准全景指南/6-语音编解码器与Tokenizer评测]]|
...
- [[3-客观评价指标体系]] — 传统客观指标详细参考

- [[DL/TTS/Qwen3-TTS Technical Report/TTS 评测基准全景指南/7-前沿TTS模型Benchmark横评]] — 当前模型横向对比数据

- [[DL/TTS/Qwen3-TTS Technical Report/TTS 评测基准全景指南/9-可控语音生成与安全评测]] — 安全与可控性评测
